<ExtensionHeader
  name="Copilot"
  description="Streaming overlay for Lightning donations."
...
See the [Copilot API documentation](./api) for endpoint details.

## Related Pages

- [Copilot API Reference](./api): API endpoints for this extension
