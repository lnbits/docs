<ExtensionHeader
  name="Gerty"
  description="Dashboard display for Bitcoin/Lightning stats."
...
See the [Gerty API documentation](./api) for endpoint details.

## Related Pages

- [Gerty API Reference](./api): API endpoints for this extension
